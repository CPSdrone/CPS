// Pour copier un fichier .mcm avec Arduino + Max7456 OSD
// Le fichier sera ensuite copié avec un émulateur de terminal
// à  9600 baud lecahrgement durera environ 3 minutes
// http://www.maxim-ic.com/tools/evkit/index.cfm?EVKit=558
// http://f5mna.free.fr

#define DATAOUT 0x0b//11-MOSI
#define DATAIN  0x0c//12-MISO 
#define SPICLOCK  0x0d//13-sck
#define MAX7456SELECT 0x0a //10-ss
...
void setup()
{
  ...
  Serial.println("Pret pour telecharger un fichier *.mcm");
  Serial.println("");
  delay(100);  
}
...
void loop()
{
  ...
  if(font_count == 256)
  {
   ...
   for (x = 0; x < MAX_font_rom; x++)
   {
    ...
    Serial.println("");
    Serial.println("Le fichier est charge.");
  }
}
